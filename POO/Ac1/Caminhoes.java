...
public class Caminhoes extends Veiculos {
    ...
    Caminhoes(String modelo, String montadora, String placa, int ano, String cor, double valor, int qtdEixos, int cargaMax, boolean faixaRefletiva, boolean luzLateral, boolean lona){
    ...
    //* Construtor Padrão
    Caminhoes(String modelo, String montadora, String placa, int ano, String cor, double valor, int qtdEixos, int cargaMax){
