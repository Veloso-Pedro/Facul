...
public class teste {
    public static void main(String[] args) {
        ...
        Carros c = new Carros("Focus", "Ford", "FJB4E12",  2015, "Preto", 25000.00, 4, 250, "Automatico");

        System.out.println(c.descricaoCarros());

        System.out.println("===== Moto =====");
        //*Modelo,montadora,placa,ano,cor,valor,cilindrada,protetormotor,alarme,bau
        Motos m = new Motos("R 1250 GS", "bwm", "luB4990", 2012, "Prata", 25000.00, 1254);
        ...
        Caminhoes i = new Caminhoes("Actros Evolution 2653 S 6x4", "mercedes", "NEX-4811", 2020, "Branco", 25000.00, 9, 74);
